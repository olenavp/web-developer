...
export default function CtaButton() {
    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 bg-gradient-to-tr from-white/0 via-card-border to-white/0 opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
        </Button>
    );
}