      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="mb-20 flex flex-col gap-8">
          <div className="space-y-6 max-w-4xl">
            <span className="text-accent font-mono uppercase tracking-[0.4em] text-[12px] font-bold">
              [ Case Study ]
            </span>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 border-l border-accent/20 pl-8 ml-2">
            ...
            <div className="flex items-center gap-3 text-accent/60 font-mono text-[12px] uppercase tracking-[0.2em]">
        ...
        <div className="flex flex-wrap  gap-12 py-16 border-y border-white/5">
          {[
            ...
            <div key={i} className="space-y-3">
              <span className="text-[12px] font-mono text-accent uppercase tracking-[0.4em] font-bold opacity-60">
                {item.label}
              </span>
